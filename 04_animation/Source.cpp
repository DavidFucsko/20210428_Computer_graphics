...
void display(GLFWwindow* window, double currentTime) {
	...
	if (xDir) {
		...
		if (x > 1.0f) inc = -0.01f; // váltsunk, balra mozogjon a háromszög.
		if (x < -1.0f) inc = 0.01f; // váltsunk, jobbra mozogjon a háromszög.
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(600, 600, "Moving Triangle", NULL, NULL);
